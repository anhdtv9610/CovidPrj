...
namespace Mgm.UserGroup
{
    public class UserGroupAppService : MgmAppServiceBase, IUserGroupAppService
    {
        ...
        private readonly IRepository<MgmUserGroupRight> _mgmUserGroupRightRepository;
        private readonly IRepository<MgmUserFunction> _mgmUserFunctionRepository;
        ...
        public UserGroupAppService(
            ...
            IRepository<MgmUserGroupRight> mgmUserGroupRightRepository,
            IRepository<MgmUserFunction> mgmUserFunctionRepository)
        {
            _mgmSysDbContext = mgmSysDbContext;

            _mgmUsersRepository = mgmUsersRepository;
            _mgmUserGroupRepository = mgmUserGroupRepository;
            _mgmUserGroupRightRepository = mgmUserGroupRightRepository;
            _mgmUserFunctionRepository = mgmUserFunctionRepository;
        }
            ...
            try
            {
                ...
                objResult.items = _mgmUserGroupRepository.GetAll()
                    .WhereIf(!input.Keyword.IsNullOrWhiteSpace(),
                        obj => obj.GroupCode.ToUpper().Contains(input.Keyword.ToUpper()) ||
                        obj.GroupName.ToUpper().Contains(input.Keyword.ToUpper()))
